  ...
  return (
    <div className="p-6 md:p-8 max-w-2xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-400 text-sm mt-1">Atualize as informações do seu funil de vendas</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {success && (
          <div className="flex items-center gap-2 bg-green-50 border border-green-100 rounded-lg px-4 py-3">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-600 flex-shrink-0">
              <polyline points="20,6 9,17 4,12" />
            </svg>
            <span className="text-green-700 text-sm">Funil atualizado com sucesso! Redirecionando...</span>
          </div>
        )}
