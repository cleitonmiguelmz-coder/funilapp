    ...
    <div className="min-h-screen bg-gray-50 flex font-sans">
      ...
      >
        <div className="px-6 py-5 border-b border-gray-100">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-gray-900 font-bold text-base tracking-tight">FunilApp</span>
              <span className="text-violet-500 text-[10px] font-semibold uppercase tracking-wider">
                Gestor do negócio
              </span>
            </div>
          </div>
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
          {navItems.map((item) => {
            const isActive =
              item.href === "/negocio" ? pathname === "/negocio" : pathname.startsWith(item.href);
            return (
              <Link
                key={item.href}
                href={item.href}
        ...
        <div className="px-3 py-4 border-t border-gray-100">
          <Link
            href="/dashboard"
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-400 hover:text-gray-900 hover:bg-gray-50 transition-all duration-150"
          >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden flex items-center justify-between px-4 py-3 border-b border-gray-100 bg-white">
          ...
          <span className="text-gray-900 font-bold text-sm">Gestor do negócio</span>
          <div className="w-8" />
        </header>
